      ...
      <Grid container spacing={8} maxWidth="lg">
        ...
        <Grid item xs={12} md={6}>
          ...
          <p className="mb-5 text-harbor-blue">
            Want to learn about MediNotes? Need help getting started? Meet one of our team members in a quick intro call.
          </p>
          <img
            src="/doctor3.png" 
            ...
            <Box component="form" noValidate autoComplete="off">
              <Grid container spacing={2}>
                ...
                <Grid item xs={12}>
                  <FormControlLabel
                    control={<Checkbox />}
                    label="Opt-in MediNotes emails (required for calendar invites). Read our Privacy Policy"
                  />
                </Grid>
                <Grid item xs={12}>
