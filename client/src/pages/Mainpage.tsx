                ...
                <div className="flex flex-col md:flex-row justify-center items-center py-12 px-10">
                    <div className="max-w-sm sm:max-w-xl mx-auto text-left p-4 mt-10">
                        ...
                        <div className="mt-10 sm:text-xl text-xl font-light sedan-font text-md text-white">
                            <p>
                                MediNotes is a clinical note-taking tool that uses AI to write clinical notes, patient summaries, and medical letters.
                                It is designed to save you time and improve the quality of your notes.
                                With a focus on privacy and security, MediNotes is a safe and secure way to start leveraging AI in your work today.
                            </p>
                        </div>
                ...
                <div className="flex flex-col sm:flex sm:flex-row  sm:justify-center sm:gap-12 pt-5 pb-24">
                    <div className="mt-12">
                        ...
                        <div className="max-w-xs pt-3 mx-auto text-white sedan-font text-xl ">
                            MediNotes Gets to the Core of Pelvic Health Documentation
                        </div>
                    ...
                    <div className="mt-12">
                        ...
                        <div className="max-w-xs pt-3 mx-auto text-white sedan-font text-xl ">
                        Swift steps for pediatrist using MediNotes on the road.
                        </div>
                    ...
                    <div className="mt-12">
                        ...
                        <div className="max-w-xs pt-3 mx-auto text-white sedan-font text-xl ">
                            Tech Meets Touch for this Osteopath using AI with MediNotes
                        </div>
            ...
            <div>
                <div>
                    ...
                    <div className="text-center mx-auto pt-5 font-semibold text-xl max-w-2xl">
                         MediNotes prioritizes the security and confidentiality of your patients’ data. Our platform meets the highest standards for AI applications in medical clinics and hospitals.
                ...
                <div className="mt-24 sm:flex justify-center flex-col-1 sm:gap-8">
                        ...
                        <div className="flex flex-col items-center sm:mt-10 mt-16">
                            ...
                            <div className="text-center max-w-md font-thin text-lg mt-3">
                                MediNotes is fully compliant with the Australian Privacy Act 1998 and the Australian Privacy Principles.
                            </div>
                        </div>
                </div>
            ...
            <section className="flex justify-center items-center min-h-screen bg-gradient-to-r from-green-100 to-blue-100 mt-24 ">
                <div className="container mx-auto flex flex-col lg:flex-row items-center p-6 gap-20">
                    ...
                    <h1 className="text-4xl lg:text-5xl font-bold mb-4">
                        MediNotes iOS app for iPhone and iPad
                    </h1>
                    ...
                    <p className="text-gray-600 text-lg mb-6">
                        Whether you are doing a consult in a gym, doing an in-home visit or just want to dictate some quick notes while they spring to mind, the MediNotes app is a great companion that works with your account. Capture the session using an iPad or iPhone and access your notes from your computer, tablet or phone. You can then use your laptop or PC to save time on other clinical admin tasks, such as medical letters and reports.
                    </p>

                    <ul className="list-disc list-inside text-gray-600 mb-6">
                        <li>Quickly create a new session</li>
                        <li>Use the power of your iPhone microphone</li>
                        <li>Access MediNotes from anywhere</li>
                    </ul>
