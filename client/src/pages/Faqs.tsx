...
const faqData: FAQItemProps[] = [
  {
    question: "How does MediNotes work?",
  ...
  },
  {
    ...
    answer: "ChatGPT isn't safe to use with patient information. Data entered into ChatGPT is retained for wider language learning models and often patient information is being entered into ChatGPT without consent. MediNotes is different. Explicit consent from the patient is required for each session. Transcripts are heavily protected with layers of encryption and strict policies, stored in Sydney in Google's HIPAA compliant data center, and automatically deleted after 30 days."
  },
  {
  ...
  {
    question: "Can I use MediNotes on my mobile phone?",
    answer: "Yes. Navigate to MediNotes.app on your web browser, login, and away you go. Recording works great on mobile devices and on most devices will continue even when the screen locks."
  },
  {
    question: "Where are MediNotes servers located?",
    answer: "MediNotes runs on servers located in Sydney, Australia. We have plans to have dedicated servers in each country with data stored locally for each user where possible. Eg. If a user sets their country to United States, their data will reside in the United States."
  },
];
